...
const heroContent = {
  ...
  intro:
    'קצר, שקע שלא עובד או תאורה שצריך להחליף או להתקין? אני יניב כהן, חשמלאי מוסמך והנדסאי חשמל, מטפל בתקלות ועבודות חשמל בבתים ובעסקים באזור תל אביב, רמת גן, הרצליה, השרון והמרכז – בצורה בטוחה, נקייה ובשקיפות מלאה.',
  details:
...
const serviceCategories: ServiceCategory[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'מענה לקריאות חירום באזור תל אביב, רמת גן, הרצליה, השרון והמרכז'
    ]
  },
  {
...
const reasons = [
  ...
  'זמינות לתקלות וחירום במרכז, תל אביב והשרון'
]
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'ניתן לפנות בטלפון או בהודעה, ותקלות חירום מטופלות באזורי המרכז, תל אביב והשרון לפי זמינות ולפי אופי התקלה.'
  },
  {
